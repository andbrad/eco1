...
```{r uganda growth rate, include=FALSE}
...
# make base plot 
plot(dNNdt~population, data=ugandadf, xlab="Nt (thousands)", ylab="dN/Ndt", xlim=c(0, 50000), ylim=c(0,0.05))
...
ggplot(ugandadf, aes(x = population, y = dNNdt)) +
  geom_point() +
